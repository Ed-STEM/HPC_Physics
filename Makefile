...
CC=clang
###Extra c flags  -Isrc
CFLAGS=-g -target arm64-apple-macos11 -O2  -Wall -Wextra -D_FORTIFY_SOURCE=2 -fstack-protector-strong -Wformat-security  -Xpreprocessor -fopenmp -fPIE  $(OPTFLAGS)
ifeq ($(UNAME_S),Darwin)
	INCLUDES=-I/opt/homebrew/opt/gsl/include -I/opt/homebrew/opt/raylib/include -I/opt/homebrew/opt/libomp/include
	LDLIBS=-L/opt/homebrew/opt/gsl/lib -L/opt/homebrew/opt/raylib/lib -L/opt/homebrew/opt/libomp/lib -W1,-z,now$(OPTLIBS)
endif
ifeq ($(UNAME_S),Linux)
